...
MARKING_ONE_C_TEMPLATE_PATH = os.getenv("MARKING_ONE_C_TEMPLATE_PATH", "") or str(
    BASE_DIR / "resources" / "trend_island_1c_template.xlsx"
)
...
LAMODA_CANCELLATION_TIME = os.getenv("LAMODA_CANCELLATION_TIME", "14:55")
LAMODA_CANCELLATION_EMAIL_TO = os.getenv("LAMODA_CANCELLATION_EMAIL_TO", "")
LAMODA_EMAIL_FROM = os.getenv("LAMODA_EMAIL_FROM", "")
LAMODA_EMAIL_SMTP_HOST = os.getenv("LAMODA_EMAIL_SMTP_HOST", "smtp.yandex.ru")
LAMODA_EMAIL_SMTP_PORT = env_int("LAMODA_EMAIL_SMTP_PORT", 465)
LAMODA_EMAIL_USERNAME = os.getenv("LAMODA_EMAIL_USERNAME", LAMODA_EMAIL_FROM)
LAMODA_EMAIL_APP_PASSWORD = os.getenv("LAMODA_EMAIL_APP_PASSWORD", "")
