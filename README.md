...
Кнопка показывает последние записи из Google Таблицы.
...
После выбора даты бот собирает все записи из Google Таблицы за эту дату, группирует их по товару и размеру и отправляет итоговый отчёт в Telegram-тему «Отчет приемки».
